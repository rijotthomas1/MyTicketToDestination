...
<?php include('DatabaseCon.php');
	...
	session_start();
	$cid=$_SESSION['uid'];
	$s="select * from tbl_flight inner join tbl_bookflight on tbl_flight.fname=tbl_bookflight.fname where cid=$cid and amount>0";
	$rs=$db->selectData($s);
	while($row=mysql_fetch_array($rs)){
		...
		<tH><a href="vfpass1.php?bkid=<?php echo $row['bkid']; ?>" style="color:green">Passenger List</a></tH>
		</tr>
