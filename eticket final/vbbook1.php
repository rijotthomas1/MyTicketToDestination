...
<?php include('DatabaseCon.php');
	...
	session_start();
	$cid=$_SESSION['uid'];
	$s="select * from tbl_bus inner join tbl_bookbus on tbl_bus.bid=tbl_bookbus.bid where cid=$cid and amount>0";
	$rs=$db->selectData($s);
	while($row=mysql_fetch_array($rs)){
		...
		<th><a href="vbpass1.php?bkid=<?php echo $row['bkid']; ?>" style="color:green">Passenger List</a></th>
		</tr>
