...
<li class="nav-item">
    ...
    <div class="touch_section">
        <div class="container">
            <h1 class="touch_text">TRAVEL COMPANIES</h1>
        </div>
    </div>
...
<?php include('DatabaseCon.php');
	...
	while($row=mysql_fetch_array($rs)){
		...
		<tH><a href="viewbus.php?cid=<?php echo $row['cid']; ?>" style="color:red">Bus Package</a></tH>
		<tH><a href="viewfl.php?cid=<?php echo $row['cid']; ?>" style="color:red">Flight Package</a></tH>
		</tr>
	<?php } ?>
	</table> </div>
                    </div>
