...
<form action='addflpassaction.php'method="get">
...
<tr> <th>phone number</th> <td><input type="number" name="ph" maxlength="10" class="email-bt" ></td> </tr>
<tr> <th> Nationality</th><td><select name="nat"required class="email-bt">
							<option value="India">India</option>
							<option value="sreelanka">Sreelanka</option>
							<option value="bangladesh">Bangladesh</option>
							<option value="china">China</option>
							</select>
<tr> <th> Class</th><td><select name="cls"required class="email-bt">
							<option value="Buissness Class">Buissness class</option>
...
<?php include('DatabaseCon.php');
	$db=new DatabaseCon();
	$bkid=$_GET['bid'];
	$s="select * from tbl_flpassenger where bkid=".$bkid;
	$rs=$db->selectData($s);
	while($row=mysql_fetch_array($rs)){
		...
		<td> <a href="deleteflpass.php?bid=<?php echo $row['fpid'] ?>&zid=<?php echo $row['bkid'] ?>&mod=flpa" style="color:red">Delete</a>
			</tr>
	<?php } ?>
	
</table> 
<a href="fpaycalculation.php?bkid=<?php echo $bkid;?>" style="color:green">PAY HERE for Booking Confirmation</a>
