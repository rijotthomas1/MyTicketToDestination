...
<li class="nav-item">
    ...
    <div class="touch_section">
        <div class="container">
            <h1 class="touch_text">BUS BOOKINGS</h1>
        </div>
    </div>
...
<?php include('DatabaseCon.php');
	...
	session_start();
	$uid=$_SESSION['uid'];
	$s="select * from tbl_bus inner join tbl_bookbus on tbl_bus.bid=tbl_bookbus.bid where uid=$uid and amount>0";
	$rs=$db->selectData($s);
	while($row=mysql_fetch_array($rs)){
		...
		<th><a href="bticket.php?bkid=<?php echo $row['bkid']; ?>" target="_blank" style="color:green">Ticket</a></th>
		<th><a href="deleteflpass.php?bkid=<?php echo $row['bkid']; ?>&mod=bcan" style="color:red">Cancel</a></th>
		</tr>
