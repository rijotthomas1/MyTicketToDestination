...
<?php include('DatabaseCon.php');
	...
	while($row=mysql_fetch_array($rs)){
		...
		<td><?php echo $row['bus_type']; ?> </td>
			<th><a href="viewstop.php?bid=<?php echo $row['bid']; ?>" style="color:blue">Stops</a></th>
		<th><a href="busbooking.php?bid=<?php echo $row['bid']; ?>" style="color:green">Book</a></th>
		</tr>
  ...
  <div class="copyright">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                   <p class="copyright_text">© 2019 All Rights Reserved.</a></p>
                </div>
            </div>
        </div>
    </div>
