...
<body>
    ...
    <div class="touch_section">
        <div class="container">
            <h1 class="touch_text">COMPANY REGISTRATION</h1>
        </div>
    </div>
...
<form action="comregaction.php"  onsubmit="return check();">
<table>

<tr> <th>Name</th> <td> <input type="text" name="nm" id="nm" required class="email-bt"> </td> </tr>

<tr> <th>Address</th> <td><textarea  name="add"  required class="email-bt"> </textarea> </td> </tr>
...
<tr> <th>Licence no:</th> <td><input type="text" name="li" required class="email-bt"> </td> </tr>

<tr> <th>owner Name</th> <td> <input type="text"  name="on" id="on" required class="email-bt"> </td> </tr>

<tr> <th>owner email</th> <td> <input type="email"  name="oe" required class="email-bt"> </td> </tr>

<tr> <th>owner phone</th> <td> <input type="text"  name="op"  id="op" maxlength ="10" required class="email-bt"> </td> </tr>

<tr> <th>password</th><td><input type="password" name="passwrd" required id="passwrd" maxlength="12" class="email-bt"> </td> </tr>
...
<script type="text/javascript">
    ...
    function check()
    {
       ...
       else if(!document.getElementById("on").value.match(letters))
        {
              
            alert('Please input alphabet characters only,enter Owners Name  name');
            return false;
        }
        ...
        else if(!document.getElementById("op").value.match(numbers))
        {
            alert('Please input numeric characters only,enter owner phone number');
            return false;
        }
     ...
     else if(document.getElementById("op").value.length<10)
        {
            alert('invalid Phone number,enter owner phone number');
            return false;
        }
     else if(document.getElementById("passwrd").value.length<8)
        {
            alert('Enter password with minimum length of 8 characters');
            return false;
        }
        else
        {
